...
for filename in parsed_files:
    ...
    for k in range(n):
        ...
        if (url_parent not in URLs): # enter a new parent topic
            ...
            uuid_parent = grakn_utils.get_uuid(url_parent)

            new_topic = {'UUID': uuid_parent ,'title':new_parent, 'URL' : url_parent}
        ...
        if (url_child not in URLs): # enter a new child topic
            ...
            new_topic = {'UUID':uuid_child,'title':new_child, 'URL' : url_child}
